...
import { MATHIEU_EXTENSION_METADATA, MATHIEU_EXTENSION_PATHS } from "./mathieu-extensions.ts";
	...
	const createRuntime: CreateAgentSessionRuntimeFactory = async ({
		...
		const services = await createAgentSessionServices({
			...
			resourceLoaderOptions: {
				additionalExtensionPaths: parsed.noExtensions
					? resolvedExtensionPaths
					: [...MATHIEU_EXTENSION_PATHS, ...(resolvedExtensionPaths ?? [])],
				additionalExtensionMetadata: parsed.noExtensions ? undefined : MATHIEU_EXTENSION_METADATA,
